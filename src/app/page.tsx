          ...
          <div className="text-center">
            <h2 className="font-headline text-3xl md:text-4xl font-bold text-foreground">
             ...
             <p className="mt-4 max-w-3xl mx-auto text-lg text-muted-foreground">
              The <Link href="/about" className="text-primary hover:underline">Phoenix Desi Sports and Cultural Club (PDSCC)</Link> is a 501(c)(3) non-profit organization at the heart of the Desi community in Arizona. We are passionately dedicated to preserving and celebrating the rich traditions of North India. Our mission is to bridge generations and connect our community by organizing vibrant festivals, sports tournaments, and cultural gatherings that are open to all AZ Desis and the wider Phoenix community. From the grand Vaisakhi Mela to the joyous Teeyan Da Mela, our events serve as a gathering place for everyone to experience the color, music, and spirit of our heritage. We strive to create a welcoming home for everyone to connect, celebrate, and belong.
            </p>
          </div>
