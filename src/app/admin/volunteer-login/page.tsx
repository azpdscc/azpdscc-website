...
export default function VolunteerLoginPage() {
  ...
  const [state, formAction] = useActionState(volunteerLoginAction, { success: false, errors: {} });

  useEffect(() => {
    if (state.success) {
      // Store a simple flag in session storage
      sessionStorage.setItem('volunteer-authenticated', 'true');
    ...
    <div className="min-h-screen flex items-center justify-center bg-secondary">
        <Card className="w-full max-w-sm">
            <CardHeader className="text-center">
                ...
                <CardTitle className="font-headline text-2xl">Volunteer Check-In Login</CardTitle>
