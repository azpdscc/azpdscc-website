...
export const metadata: Metadata = {
  ...
  description: 'Have a question or want to get involved? Contact the PDSCC team. We serve the Phoenix Punjabi Indian community and welcome your inquiries.',
};
  ...
  return (
    <div className="bg-background">
      <section className="relative h-[40vh] min-h-[300px] w-full flex items-center justify-center text-center text-primary-foreground">
        <HeroImage src="https://pdscc-images-website-2025.s3.us-east-1.amazonaws.com/contact.jpg" alt="Person writing a letter" aiHint="contact us" />
